...
//if length is odd return false
    //if it starts with closing bracket return false
    // else keep adding in stack if opening bracket comes
    //else if closing bracket comes pop from top and check parallel bracket
