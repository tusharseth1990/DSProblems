...
public class CourseScheduleII {
    ...
    public int[] findOrder(int n, int m, ArrayList<ArrayList<Integer>> prerequisites) {
        // Form a graph
        ArrayList<ArrayList<Integer>> adj = getAdjListFromPrequisites(n, m, prerequisites);
    ...
    private static ArrayList<ArrayList<Integer>> getAdjListFromPrequisites(int n, int m, ArrayList<ArrayList<Integer>> prerequisites) {
    ...
    public static void main(String[] args) {
        ...
        int[] ans = obj.findOrder(N,M,prerequisites);
        for (int task : ans) {
